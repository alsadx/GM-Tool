...
func New(log *slog.Logger, userSaver srv.UserSaver, userProvider srv.UserProvider, tokenTTL time.Duration, hasher Hasher, tokenManager *jwt.TokenManager) *Auth {
	return &Auth{
		Log:          log,
		UserSaver:    userSaver,
...
func (a *Auth) Logout(ctx context.Context, token string) error {
	...
	err = a.UserSaver.DeleteSession(ctx, parsedJWT.UserId)
	if err != nil {
