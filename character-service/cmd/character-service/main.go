...
import (
	...
	character_core "github.com/alsadx/gm-protos/gen/go/characterv1/character_core"
	...
	character_stats "github.com/alsadx/gm-protos/gen/go/characterv1/character_stats"
...
func main() {
	port := flag.Int("p", 50053, "API handler port. Can be overridden by PORT env var.")
	flag.Parse()
